...
document.getElementById("form01-kml_file").onchange = function() {
...
function getFileSelected(){
    ...
    var getFileSelected = document.getElementById("form01-kml_file").value;

    document.getElementById("file-selected").innerHTML = "FILE SELECTED";

}

document.getElementById('form01-button').addEventListener('click', openDialog);

function openDialog() {
  document.getElementById('form01-kml_file').click();
}
